        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h1 class="Formulario__Titulo">Editar Farmacia</h1>
                </div>
            </div>
        </div>
        <br>
                    ...
                    <div class="formulario__sucursal">
                        <form class="formulario__registro" action="{{ route('Sucursales.update', $Sucursale->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="Descripcion" value="{{ old('Descripcion', $Sucursale->Descripcion) }}" placeholder="Ingrese Una Descripción">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Dirección:</label>
                                <input type="text" class="form-control" name="Direccion" value="{{ old('Direccion', $Sucursale->Direccion) }}" placeholder="Ingrese Su Dirección" aria-describedby="emailHelp">
                                </div>
                                <div class="form-group">
                                <label for="exampleInputPassword1">Telefono:</label>
                                <input type="number" class="form-control" name="Telefono" value="{{ old('Telefono', $Sucursale->Telefono) }}" placeholder="Ingrese Su Número Teléfonico">
                            </div>
