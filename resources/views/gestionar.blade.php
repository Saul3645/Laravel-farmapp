            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="formulario__sucursal">
                        <form class="formulario__registro" action={{ route('Sucursales.store') }} method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="Descripcion"
                                    value="{{ old('Descripcion') }}" placeholder="Ingrese Una Descripción">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Dirección:</label>
                                <input type="text" class="form-control" name="Direccion"
                                    value="{{ old('Direccion') }}" placeholder="Ingrese Su Dirección"
                                    aria-describedby="emailHelp">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Telefono:</label>
                                <input type="number" class="form-control" name="Telefono"
                                    value="{{ old('Telefono') }}" placeholder="Ingrese Su Número Teléfonico">
                            </div>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="formulario__medicamentos">
                        <form class="formulario__registro" action={{ route('Medicamentos.store') }} method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="Caracteristicas"
                                    value="{{ old('Caracteristicas') }}" placeholder="Ingrese Sus Caracteristicas"
                                    aria-describedby="emailHelp">
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-success"><i class="fas fa-prescription-bottle-alt"></i>Registrar</button>
